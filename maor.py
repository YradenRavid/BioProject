...
true_order = np.zeros((test.shape[0],10))
loops = test.shape[0]//original_test_len + 1
part = original_test_len//10
i=0
for loop in range (0,loops):
    for col in range (0,10):
        true_order[loop * original_test_len + col * part:loop * original_test_len + (col + 1) * part, col] = 1
true_order[(loop)*original_test_len +col*part:,9] = 1
